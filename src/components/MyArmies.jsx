...
const victor = new Unit("dt-26", 6, 100, skills_by_unit_type.infantry);
const victor3 = new Unit("dt-26", 5, 100, skills_by_unit_type.infantry);
const transport = new Unit("victor's transport", 1, 150, skills_by_unit_type.transport_tank);
transport.skills.movement = 4
const yoamelInABike = new Unit("yoamel", 1, 55, skills_by_unit_type.rider)
const yoamelInABike2 = new Unit("yoamel", 1, 55, skills_by_unit_type.rider)
const yoamelInABike3 = new Unit("yoamel", 1, 55, skills_by_unit_type.rider)
const victor2 = new Unit("dt-26", 10, 100, skills_by_unit_type.infantry);
const transport2 = new Unit("victor's transport", 1, 150, skills_by_unit_type.transport_tank);

const riding_victor = new Formation("riding victor", [yoamelInABike, yoamelInABike2, yoamelInABike3], "assault", "is just me as a lone wolve model assaulting in a tank", "https://i.pinimg.com/474x/5d/69/1c/5d691c4e1e7b4a6f9913033d805e301e.jpg")
